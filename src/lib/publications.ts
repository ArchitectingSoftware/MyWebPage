export const PublicationsList = [
    
    {
        ...
        abstract:"Cloud compute adoption has been growing since its inception in the early 2000's \
                    ...
                    being paid to advancing software engineering practices needed to support the current \
                    and next generation of cloud native applications.  By cloud native, we mean software that \
                    is designed and built specifically for deployment to a modern cloud platform. This paper \
                    frames the landscape of Cloud Native Software Engineering from a practitioners standpoint, \
